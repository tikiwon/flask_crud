...
def test_create_users(client):
    ...
    # Validate username with over 50 characters
    assert resp10.status_code == 409
    assert not isinstance(resp10.json, dict)

    # Validate email with over 50 characters
...
def test_update_user(client):
    ...
    resp8 = client.put('/users/2', json={'username': 'ladrao', 'email': 'robervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalrobervalroberval@gmail.com'})
    resp9 = client.put('/users/2', json={'username': 'ladraoladraoladraoladraoladraoladraoladraoladraoladraoladrao', 'email': 'roberval@gmail.com'})
